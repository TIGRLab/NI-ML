...
parallel="parallel -j12"
stdlabel=std/ADNI_037_S_0150_MR_MPR-R__GradWarp__N3__Scaled_Br_20070806150947680_S11434_I65130.mnc

tempdir1=$(mktemp -d --tmpdir=/export/ramdisk)
tempdir=$(mktemp -d --tmpdir=/export/ramdisk)

function cleanup { rm -rf $tempdir1 $tempdir ; }; trap cleanup EXIT;
