...
source_path = '/projects/nikhil/tmp/standardized_input_data_{}_{}_mini.h5'
source_path_labels = '/projects/nikhil/tmp/standardized_input_classes_mini.h5'
...
for side in sides:
    for structure in structures:
        ...
        for s in ['train', 'valid', 'test']:
            X[side][structure][s] = data.get_node(features_template.format(s))[:]
        ...
        make_fuel_file('{}{}_{}_mci_cn.h5'.format(target_path, structure, side.lower()), num_train, num_valid, num_test, X_c, y_c,
                       side.lower())
