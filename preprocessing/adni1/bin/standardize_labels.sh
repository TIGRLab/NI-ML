...
std_l=02_std/model_labels_res_l.mnc
std_r=02_std/model_labels_res_r.mnc
...
[ -e $reg_l ] || ants_reg $std_l $out_l ${output_stem}_l_
[ -e $reg_r ] || ants_reg $std_r $out_r ${output_stem}_r_
