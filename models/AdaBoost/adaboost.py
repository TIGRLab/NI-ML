...
# Parameters used by specific experiments:
param_map = {
    'adaboost': ['n_estimators', 'learning_rate', 'max_depth'],
    'linearSVM': ['C'],
    'pca_svm': ['C', 'n_components'],
    'pca_lr': ['C', 'n_components'],
}


def adaboost(n_estimators, learning_rate, max_depth):
...
def experiment_on_fold(params, X, X_v, X_t, y, y_v, y_t):
    ...
    classifier = adaboost(n_estimators, learning_rate)
